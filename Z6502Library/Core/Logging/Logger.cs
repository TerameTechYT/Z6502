...
namespace Z6502.Core.Logging
{
    ...
    public class Logger
    {
        ...
        public static void LogFatal(string message, string source)
        {
            Log(message, source, Severity.Fatal);
        }
        ...
        {
            Log(message, source, Severity.Error);
        }
        ...
        {
            Log(message, source, Severity.Warn);
        }
        ...
        {
            Log(message, source, Severity.Info);
        }
        ...
        public static void LogDebug(string message, string source)
        {
            ...
            Log(message, source, Severity.Debug);
        }
